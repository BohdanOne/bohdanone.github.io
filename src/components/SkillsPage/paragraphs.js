const paragraphs = [
  ...
  'My websites and apps are build on foundation of meaningful and accessible HTML. I try to explore all the possibilities that modern HTML5 provides. Layouts are build with CSS3 features like Flexbox or Grid. I’m familiar with SASS and frameworks such as Bootstrap and Semantic UI.',
  ...
  'During development process I’m using tools such as Webpack and Babel. Of course all my projects are backed-up with Git, remote repositiories are stored at GitHub.',
