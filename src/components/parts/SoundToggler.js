...
class SoundToggler extends React.Component {
  render() {
    if (this.props.sound === 'on') {
      return (
        <button onClick={this.props.onClick} role="switch" aria-checked="true">
          <svg id="soundIcon" className="icon" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
      ...
      return (
        <button onClick={this.props.onClick} role="switch" aria-checked="false">
          <svg id="soundIcon" className="icon" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
